...
head_to_head AS (
    SELECT
        ...
        ROUND(SUM(CASE WHEN winner_clean = LEAST(team1_clean, team2_clean) THEN 1 ELSE 0 END) * 100.0 / COUNT(*), 1) AS team_a_win_pct
    FROM standardised
...
SELECT * FROM head_to_head_stats LIMIT 5;